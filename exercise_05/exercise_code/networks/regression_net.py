...
class RegressionNet(Network):
    ...
    def forward(self, X):
        ...
        y, cache_affine2 = affine_forward(out2, W2, b2)
        ########################################################################
        #                           END OF YOUR CODE                           #
        ########################################################################
    ...
    def backward(self, dy):
        ...
        din, dW2, db2 = affine_backward(dy, cache_affine2)
        dsigmoid = sigmoid_backward(din, cache_sigmoid)
        _, dW1, db1 = affine_backward(dsigmoid, cache_affine1)
